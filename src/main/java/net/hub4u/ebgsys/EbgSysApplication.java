...
//
//			Arrays.asList(
//				new Product("Clou 21", "PRD-EBG-0000103", "Description Clou 21", new BigDecimal("5000"), new BigDecimal("130000"), new BigDecimal("100000"), 50, 100),
//				new Product("Arrache clou", "PRD-EBG-0000102", "Description Arrache clou", new BigDecimal("2000"),new BigDecimal("20000"), new BigDecimal("15000"), 10, 25 ),
//				new Product("Barbelets 10m", "PRD-EBG-0000114", "Description Barbelets 10 mmmm", new BigDecimal("105000"), new BigDecimal("1200000"), new BigDecimal("1000000"), 10, 20),
//				new Product("Fer 200", "PR-EBG-0000113", "Fer 200 pour béton armé", new BigDecimal("20000"), new BigDecimal("120000"), new BigDecimal("100000"), 5, 10)
